...
| Shared persistence   | PostgreSQL through SeaORM + private object storage | Typed backend persistence, ORM-managed schema changes, classroom records and uploaded material bytes |
