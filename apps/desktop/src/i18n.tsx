...
const english = {
  ...
  'runtime.finePrint':
    'A diagnostic session checks the process connection. Teaching and computer actions arrive in the next milestone.',
  ...
  'teaching.plan': 'Plan guidance / replan',
  ...
  'voice.loading': 'Loading voice control…',
  'voice.aria': 'Voice control',
  'voice.eyebrow': 'Fast computer control',
  'voice.heading': 'Hold two keys. Speak. Release.',
  'voice.enable': 'Enable voice',
  'voice.permissions': 'Check permissions',
  'voice.disable': 'Disable voice',
  'voice.cancel': 'Cancel instruction',
  'voice.textLabel': 'Type instead of speaking',
  'voice.textPlaceholder': 'e.g. Open the settings panel',
  'voice.run': 'Run instruction',
  'voice.finalInstruction': 'Final instruction',
  'voice.listeningTranscript': 'Listening transcript',
  'voice.clearTranscript': 'Clear transcript',
  'voice.queue': 'Follow-up queue',
  'voice.queued': '{count} queued',
  'voice.followUpPending':
    'Your follow-up will appear here after transcription.',
  'voice.followUpHint': 'Hold {shortcut} again to add a follow-up.',
  'voice.selectedWindow': 'Selected window:',
  'voice.approvalRequired': 'Approval required',
  'voice.approve': 'Approve action',
  'voice.reject': 'Reject action',
  'voice.statusUnavailable': 'Voice status is unavailable.',
  'voice.statusUnverified': 'Voice status could not be verified.',
  'voice.requestFailed': 'Voice control could not complete that request.',
  ...
  'voice.phase.executing': 'Working',
  'voice.phase.confirmation': 'Approval',
  'voice.phase.completed': 'Completed',
  'voice.phase.cancelled': 'Cancelled',
  'voice.phase.failed': 'Failed',
  'voice.status.fallback': 'Voice control status changed.',
...
const vietnamese: Record<TranslationKey, string> = {
  ...
  'runtime.finePrint':
    'Phiên chẩn đoán kiểm tra kết nối tiến trình. Chức năng giảng dạy và thao tác máy tính sẽ có ở cột mốc tiếp theo.',
  ...
  'teaching.plan': 'Lập / lập lại hướng dẫn',
  ...
  'voice.loading': 'Đang tải điều khiển bằng giọng nói…',
  'voice.aria': 'Điều khiển bằng giọng nói',
  'voice.eyebrow': 'Điều khiển máy tính nhanh',
  'voice.heading': 'Giữ hai phím. Nói. Thả ra.',
  ...
  'voice.textPlaceholder': 'Ví dụ: Mở bảng cài đặt',
  'voice.run': 'Chạy chỉ dẫn',
  'voice.finalInstruction': 'Chỉ dẫn cuối cùng',
  'voice.listeningTranscript': 'Bản chép lời đang nghe',
  'voice.clearTranscript': 'Xóa bản chép lời',
  'voice.queue': 'Hàng đợi tiếp theo',
  'voice.queued': '{count} đang chờ',
  'voice.followUpPending':
    'Nội dung tiếp theo sẽ xuất hiện tại đây sau khi chép lời.',
  'voice.followUpHint': 'Giữ lại {shortcut} để thêm chỉ dẫn tiếp theo.',
  'voice.selectedWindow': 'Cửa sổ đã chọn:',
  'voice.approvalRequired': 'Cần phê duyệt',
  'voice.approve': 'Phê duyệt thao tác',
  'voice.reject': 'Từ chối thao tác',
  ...
  'voice.requestFailed':
    'Điều khiển bằng giọng nói không thể hoàn tất yêu cầu này.',
  'voice.permissionRecovery':
  ...
  'voice.phase.executing': 'Đang thực hiện',
  'voice.phase.confirmation': 'Chờ phê duyệt',
  'voice.phase.completed': 'Hoàn tất',
  'voice.phase.cancelled': 'Đã hủy',
  'voice.phase.failed': 'Thất bại',
  'voice.status.fallback': 'Trạng thái điều khiển bằng giọng nói đã thay đổi.',
...
const knownMessages: Partial<Record<string, TranslationKey>> = {
  ...
  'Selected-window observation checks access when you press Observe. Protected or elevated windows may be unavailable.':
    'teaching.permissionHelp',
  'Enable voice control to use push-to-talk.': 'voice.phase.disabled',
  'Voice permissions are required.': 'voice.permissionRecovery',
  'Listening…': 'voice.phase.listening',
  'Listening for a follow-up…': 'voice.phase.listening',
  'Finalizing the instruction…': 'voice.phase.transcribing',
  'Preparing the selected window…': 'voice.phase.dispatching',
  'Adding the follow-up to the queue…': 'voice.phase.dispatching',
  'Starting the selected-window action…': 'voice.phase.dispatching',
  'Working in the selected window…': 'voice.phase.executing',
  'Approval is required before this action.': 'voice.approvalRequired',
  'Instruction completed.': 'voice.phase.completed',
  'Voice instruction cancelled.': 'voice.phase.cancelled',
  'Instruction cancelled.': 'voice.phase.cancelled',
  'Voice control is disabled.': 'voice.phase.disabled',
  'Voice control is disabled until you sign in again.': 'voice.phase.disabled',
};
